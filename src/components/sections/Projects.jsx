...
export const Projects = () => {
    return (
        ...
        >
            <RevealOnScroll>
                <div className="max-w-5l mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        >
                            ...
                            <p className="text-gray-300 mb-4">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas magni suscipit recusandae iste a corporis, magnam nam laudantium autem consectetur dolorum quidem quas ex maxime hic consequuntur soluta sapiente sint.
                            </p>
